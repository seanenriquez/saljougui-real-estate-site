	...
	<div class="wrap">
		<div class="row">
			<div class="col-md-12">
				...
				<!--
				<h4 class="text-center text-info">Below are the current listings available in <?= $this->model->getCityStZip() ?>--> 
        <span class="blink instruct">&nbsp;&nbsp;&nbsp;Scroll Down <i class="fa fa-arrow-down"></i></span></h4>
				<hr />
