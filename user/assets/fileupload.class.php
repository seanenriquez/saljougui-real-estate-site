...
class qqFileUploader {
	 ...
	 */
    function handleUpload($uploadDirectory, $replaceOldFile = FALSE, $make_thumb = TRUE){
		...
		/* Make Thumb if $make_thumb = TRUE */
		
		if($make_thumb)
		{
//			mail("josh@fencl.us", "Images resizing", "The server should now be creating a thumbnail of $filename");
		}		
