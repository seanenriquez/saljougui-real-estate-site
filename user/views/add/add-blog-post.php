...
<ul class="breadcrumb">
  ...
  <div class="well well-small">
    ...
    <h1>Add Blog Post</h1>
    <form action="<?=$_SERVER['PHP_SELF'] . '?type=blog';?>" method="post" id="add-blogpost-form">
    <input type="hidden" name="post_action" value="add_blog_post">
     <legend><? if($update_status)
	{
		switch($update_status)
		{
			case "added":
			?>
            <p class="alert alert-success">Blog Post added successfully!</p>
            <?
			break;
